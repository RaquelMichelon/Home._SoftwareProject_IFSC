...
<body>
    <?php
    session_start();
    $includeVerificaLogin = "./log-in-page/includes/verifica_login.inc.php";
        ...
        <ul class="geral">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="http://localhost/PROJETO-DE-SOFTWARE-II/homeProjetoFinal/index.php">
    ...
    <script>
        ...
        // trocar o iframe quando clicar em cada botão da sidebar
        const verAva = document.getElementById("verAva");
        const verCad = document.getElementById("verCad");

        verAva.addEventListener("click", 
            function (event) {
                go("http://localhost/PROJETO-DE-SOFTWARE-II/homeProjetoFinal/ver-avaliacoes/index.php");
        });
