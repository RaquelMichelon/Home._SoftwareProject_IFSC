...
<html>
    ...
    <body>
        ...
        <div class="header">
        <img src="./css/images/logo-home.svg" alt="Logo">
        ...
        <form action="sign-up.php" method="post">
            ...
            <fieldset>
                ...
                <button name="cadastrar"> 
                    <a href="http://localhost/PROJETO-DE-SOFTWARE-II/homeProjetoFinal/index.php">Voltar</a>
                     </button>
        ...
        <?php
            $includeDataBase = "./includes/data-base-class.inc.php";
