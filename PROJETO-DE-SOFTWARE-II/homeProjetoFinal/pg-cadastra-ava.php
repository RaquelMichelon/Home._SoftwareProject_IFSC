<?php
//antes de prosseguir, abrir ou iniciar a sessão
session_start();
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/PROJETO-DE-SOFTWARE-II/homeProjetoFinal/css/styles.css">
...
<body>
    ...
    <main>
                ...
                <form action="pg-cadastra-ava.php" method="post" name="form-ava-submit" role="form">
                    ...
                    <div class="page slide-page">
                        ...
                        <div class="checkbox-morador">
                            <!-- <p>Marque esta opção se você residiu no imóvel a ser avaliado</p> -->
        ...
        <!-- <script type="text/javascript">
            function mostrar() {
                swal('Avaliação do imóvel cadastrada com sucesso!', 'Obrigado por compartilhar sua experiência com outras pessoas.', 'success');
            } -->
        </script>
    ...
    <!-- <footer>
        <nav>
            <ul class="redes-sociais">
                <li><a href="#"><img src="/Images/facebook-app-symbol.svg" alt="Facebook"></a></li>
                <li><a href="#"><img src="/Images/instagram.svg" alt="Instagram"></a></li>
                <li><a href="#"><img src="/Images/youtube.svg" alt="Facebook"></a></li>
            </ul>
        </nav>
    </footer> -->
...
if(isset($_POST['cadastrar'])) //cadastrar é o name do botao submit
{
    ...
    $sql = "INSERT INTO notas (valor_nota, idavaliacao, iditens_avaliacao) 
            ...
            if ($conexaoAvaliacao->query($sql) === false)
            {
